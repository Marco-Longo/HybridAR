...
namespace GoogleARCore.Examples.AugmentedImage
{
    ...
    public class AugmentedImageVisualizer : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            debugText.text = "Image Info:\n Centre Pose: " + Image.CenterPose.ToString() + "\n Index: " + Image.DatabaseIndex +
                             "\n Width: " + Image.ExtentX + "\n Height: " + Image.ExtentZ + "\n Distance: " + EstimateDistance() + " m";
        }

        private float EstimateDistance()
        {
            Pose objectPose = Image.CenterPose;
